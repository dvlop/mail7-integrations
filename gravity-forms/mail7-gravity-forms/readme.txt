...
Contributors: mail7
Tags: gravity forms, email validation, email verification, form validation, spam
...
Real-time email validation for Gravity Forms email fields, powered by Mail7. Blocks only confirmed-invalid addresses and never rejects one it cannot verify.

== Description ==

This add-on validates every Gravity Forms email field the moment the form is submitted, using the [Mail7](https://mail7.net) API (format, MX records and a live SMTP mailbox check).
...
* Settings live under Forms, Settings, Mail7.
...
4. Go to Forms, Settings, Mail7 and (optionally) enter your Mail7 API key.

That is it. Every email field on every form is now validated on submit.
...
= 1.0.0 =
* Initial release: validate Gravity Forms email fields via Mail7, honest Valid / Not Valid / Unknown, fail-open, optional strict mode.
